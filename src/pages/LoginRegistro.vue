...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form v-on:submit.prevent="login">
      ...
      <input type="password" id="password" class="fadeIn third" name="login" placeholder="Password" v-model="pasword">
...
export default {
    ...
    methods:{
        login(){
            ...
            axios.post('https://databasejaa-default-rtdb.firebaseio.com/', json)
            .then(data =>{
                console.log(data)
            })
        }
